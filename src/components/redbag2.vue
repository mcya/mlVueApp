			...
			<div class="box">
				<div class="cont">
					<div class="step-one" v-show="isTrue">
						...
						<div v-show="isShow" class="btn" @click="openBag">重新签到</div :alertShow='alertShow'>
						<!-- <div v-show="isGoto" class="btn" @click="gotome">关闭</div>-->
					</div>
...
<script>
	...
	export default{
		...
		methods:{
			/*gotome:function(){
				window.location.href = '#/guider_me'; 
			},*/
			...
			openBag:function(){
				...
				$.ajax({
					url:'http://mall.mlxing.com/api/prize/saveActivityUser',
					data:obj,
					dataType:'jsonp',
