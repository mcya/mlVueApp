...
//				childWords:'',
		...
		props:['amount','reward_num'],//接受父页面传过来的参数
...
//			this.reward_num = this.$route.params.reward_num;
			...
			if(this.amount-this.reward_num<=0){
					this.chazhi=this.reward_num-this.amount;
				}
			

//			$.ajax({
//						url:'http://weixin.mlxing.com/shop/get_acc_amount',
////						data:{},
//						//type:'POST',
//						dataType:'jsonp',
...
//									self.chazhi=self.checkNum-self.amount;
//							}
//						}
//					});
		},
